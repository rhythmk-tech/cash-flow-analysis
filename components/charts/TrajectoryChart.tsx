...
export default function TrajectoryChart({ weekly, forecastStart }: { weekly: WeekRow[]; forecastStart: Date }) {
    ...
    <svg className="chart-svg" viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none">
      ...
      {active !== null && (
        <ChartTooltip
          ...
          lines={[weekDateRange(weekly[active].week, forecastStart), `Balance: ${money(weekly[active].balance)}`]}
          viewW={W}
          viewH={H}
        />
      )}
